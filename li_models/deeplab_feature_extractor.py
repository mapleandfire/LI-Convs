"""
Modified deeplab feature extractor
"""
...
from li_models import li_backbones
...
def _li_mobilenet_v2(
	...
	# the scope for 'li_mobilenet_v2' is still set to 'MobilenetV2' for compatibilities
	with tf.variable_scope(
			scope, 'MobilenetV2', [net], reuse=reuse) as scope:
		return mobilenet_v2.mobilenet_base(
			net,
			conv_defs=li_backbones.get_li_mnv2_def(),
			depth_multiplier=depth_multiplier,
			min_depth=8 if depth_multiplier == 1.0 else 1,
			divisible_by=divisible_by,
			final_endpoint=final_endpoint or _MOBILENET_V2_FINAL_ENDPOINT,
...
name_scope = {
	...
	'li_mobilenet_v2': 'MobilenetV2',
	'resnet_v1_50': 'resnet_v1_50',
	'resnet_v1_50_beta': 'resnet_v1_50',
	'li_resnet_v1_50_beta': 'resnet_v1_50',
	'resnet_v1_101': 'resnet_v1_101',
	'resnet_v1_101_beta': 'resnet_v1_101',
	'li_resnet_v1_101_beta': 'resnet_v1_101',
