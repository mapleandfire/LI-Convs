...
def get_model_init_fn(train_logdir,
  ...
  if tf_initial_checkpoint is None:
    print('Not initializing the model from a checkpoint.')
    return None

  if tf.train.latest_checkpoint(train_logdir):
    print('Ignoring initialization; other checkpoint exists')
    return None

  print('Initializing model from path: {}\n'.format(tf_initial_checkpoint))
  ...
  if variables_to_restore:
    init_op, init_feed_dict = contrib.framework.assign_from_checkpoint(
        tf_initial_checkpoint,
